            ...
            <div className="w-full h-full p-10 border shadow-lg bg-white mx-auto mt-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="flex justify-between mb-4">	
                        <div className="w-1/3">
                            <Label htmlFor="unitConcern" className="text-lg">Unit concern</Label>
							<Select name="unitConcern" value={formData.unitConcern} onValueChange={(value) => handleSelectChange("unitConcern", value)}>
                                <SelectTrigger className="w-full">
                                    <SelectValue placeholder="Select Office" />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="case_study">Case Study Report</SelectItem>
                    ...
                    <p className="text-sm font-bold mt-2 bg-zinc-200 p-2 ">I. CLIENTELE IDENTIFYING INFORMATION</p>
                    <div className="flex space-x-4 text-lg">
                        <div className="w-1/2 mt-1">
                            <Label htmlFor="name" className="text-lg">Full Name</Label>
                            <Input id="name" name="name" type="text" value={formData.name} onChange={handleChange} placeholder="Enter full name" />
                        </div>
                        <div className="w-1/4 mt-1">
                            <Label htmlFor="bday" className="text-lg">Birthdate</Label>
                            <Input id="bday" name="bday" type="date" value={formData.bday} onChange={handleChange} placeholder="Enter Birthday" />
                        </div>
                        <div className="w-1/4 mt-1">
                            <Label htmlFor="num" className="text-lg">Contact Number</Label>
                            <Input id="num" name="contactNumber" type="number" value={formData.contactNumber} onChange={handleChange} placeholder="Enter Contact Number" />
                        </div>
						<div className="w-1/4 mt-1">
							<Label htmlFor="sex" className="text-lg">Sex</Label>
							<Select
								name="sex"
								value={formData.sex}
                    ...
                    <div className="flex space-x-4">
                        <div className="w-1/3">
                            <Label htmlFor="house-number" className="text-lg">House Number</Label>
                            <Input id="house-number" name="houseNumber" type="text" value={formData.houseNumber} onChange={handleChange} placeholder="Enter House Number" />
                        </div>
                        <div className="w-1/3">
                            <Label htmlFor="purok" className="text-lg">Purok</Label>
                            <Input id="purok" name="purok" type="text" value={formData.purok} onChange={handleChange} placeholder="Enter Purok" />
                        </div>
                        <div className="w-1/3">
                            <Label htmlFor="barangay" className="text-lg">Barangay</Label>
							<Select name="barangay" value={formData.barangay} onValueChange={(value) => handleSelectChange("barangay", value)}>
                                <SelectTrigger className="w-full">
					...
					<div className="flex space-x-4 text-lg">
						<div className="w-1/3 mt-1">
							<Label htmlFor="education" className="text-lg">Educational Attainment</Label>
						...
						<div className="w-1/3 mt-1">
							<Label htmlFor="income" className="text-lg">Income Range (Monthly)</Label>
						
							<Select name="income" value={formData.income} 
								...
								<SelectContent>
									...
									<SelectItem value="15,001 - 20,000">15,001 - 20,000</SelectItem>
						...
						<div key={index} className="flex space-x-4 text-lg">
							<div className="w-full mt-4 p-4 border border-gray-300 rounded-md">
								<div className="flex justify-between items-center mb-4">
									...
									<Button type="button" onClick={() => handleDeleteFamilyMember(index)} className="bg-red-500 hover:bg-red-600 text-white">
										<Trash2 />
									</Button>
								</div>
								...
								<div className="flex space-x-4">
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-name-${index}`} className="text-lg">Family Member Name</Label>
										<Input
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-age-${index}`} className="text-lg">Age</Label>
										<Input
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-sex-${index}`} className="text-lg">Sex</Label>
										<Select
											name="sex"
											value={member.sex}
											onValueChange={(value) => {
												...
												const updatedFamilyMembers = [...formData.familyMembers];
												updatedFamilyMembers[index] = { ...updatedFamilyMembers[index], sex: value };
												setFormData(prevData => ({ ...prevData, familyMembers: updatedFamilyMembers }));
											}}
										>
											<SelectTrigger className="w-full">
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-civil-status-${index}`} className="text-lg">Civil Status</Label>
										<Select
											name="civilStatus"
											value={member.civilStatus}
											onValueChange={(value) => {
												const updatedFamilyMembers = [...formData.familyMembers];
												updatedFamilyMembers[index] = { ...updatedFamilyMembers[index], civilStatus: value };
												setFormData(prevData => ({ ...prevData, familyMembers: updatedFamilyMembers }));
											}}
										>
											<SelectTrigger className="w-full">
								...
								<div className="flex space-x-4">
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-relationship-${index}`} className="text-lg">Relationship to Client</Label>
										<Select
											name="relationship"
											value={member.relationship}
											onValueChange={(value) => {
												const updatedFamilyMembers = [...formData.familyMembers];
												updatedFamilyMembers[index] = { ...updatedFamilyMembers[index], relationship: value };
												setFormData(prevData => ({ ...prevData, familyMembers: updatedFamilyMembers }));
											}}
										>
											<SelectTrigger className="w-full">
											...
											<SelectContent>
												...
												<SelectItem value="Common Law Wife">Common Law Wife</SelectItem>
												<SelectItem value="Common Law Husband">Common Law Husband</SelectItem>
												<SelectItem value="Other">Other</SelectItem>
											</SelectContent>
										</Select>
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-education-${index}`} className="text-lg">Educational Attainment</Label>
										<Select
											name="education"
										...
										>
											...
											<SelectContent>
												<SelectItem value="No Formal Education">No Formal Education</SelectItem>
												<SelectItem value="Primary">Primary (Elementary)</SelectItem>
												<SelectItem value="Undergraduate High School">Undergraduate High School</SelectItem>
												<SelectItem value="High School">High School</SelectItem>
												<SelectItem value="Vocational">Vocational</SelectItem>
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`income-${index}`} className="text-lg">Income Range (Monthly)</Label>
										<Select
											name="income"
											value={member.income}
											onValueChange={(value) => {
												const updatedFamilyMembers = [...formData.familyMembers];
												updatedFamilyMembers[index] = { ...updatedFamilyMembers[index], income: value };
												setFormData(prevData => ({ ...prevData, familyMembers: updatedFamilyMembers }));
											}}
										>
											<SelectTrigger className="w-full">
									...
									<div className="w-1/4 mt-1">
										<Label htmlFor={`family-occupation-${index}`} className="text-lg">Occupation</Label>
										<Input
					...
					<Button type="button" onClick={handleAddFamilyMember} className="mt-4">Add Family Member</Button>
				</div>
		  <div>
                        <p className="text-sm font-bold mt-2 bg-zinc-200 p-2 mb-3">III. Remarks</p>
                        <textarea
                            id="remarks"
                            name="remarks"
                            rows="4"
